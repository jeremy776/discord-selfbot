// THIS CODE FROM : https://gist.github.com/Allvaa/0320f06ee793dc88e4e209d3ea9f6256
  ...
  resolveData() {
    ...
    if (this.options.replyTo !== undefined) {
      Object.assign(this.data, {
        message_reference: {
          message_id: this.options.replyTo.id
        }
      });
    }
    return this;
...
class Message extends Structures.get("Message") {
  reply(content, options) {
    return this.channel.send(ExtAPIMessage.create(this, content, options, {
      replyTo: this
    }).resolveData());
  }
